...
// Режим модерации: на странице остаются первый экран (целиком) и второй,
// на котором — только заголовок «Щитовидка под контролем» и кнопка регистрации.
// Остальные блоки скрыты через CSS (.is-moderation на .page-shell).
// Откат: поставить false и передеплоить — разметка вернётся к полной версии.
        ...
        <div class="course-offer__layout course-offer__layout--balanced">
          <div class="course-offer__content course-offer__content--balanced">
            ...
            <h2 class="course-offer__title" id="course-offer-title">
              ...
              <span class="course-offer__title-line course-offer__title-line--nowrap">под контролем${MODERATION ? '' : ':'}</span>
            </h2>
